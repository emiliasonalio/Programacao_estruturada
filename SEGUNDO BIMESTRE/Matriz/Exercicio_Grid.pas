...
type
  TForm1 = class(TForm)
    ...
    procedure SubMenu111Click(Sender: TObject);
    procedure SubMenu221Click(Sender: TObject);
  private
...
procedure TForm1.SubMenu111Click(Sender: TObject);
begin
  ShowMessage('teste submenu 1.1');
end;

procedure TForm1.SubMenu221Click(Sender: TObject);
begin
  ShowMessage('teste submenu 2.1');
end;
